== SUSE Linux Enterprise Micro 1.0 (SLE Micro 1.0) Release Notes

This repository contains release notes for SUSE Linux Enterprise Micro 1.0.
...
If you do not have write access to the repository, please ask Frank Sundermeyer <fs@suse.com> or Stefan Knorr <sknorr@suse.com> for it.
====
