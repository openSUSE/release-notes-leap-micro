...
For example, to work on the releases notes for SLES Micro 5.0, select https://gitlab.suse.de/documentation/release-notes-sles/tree/5_0[SLE Micro 5.0 branch].
