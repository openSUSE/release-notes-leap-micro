...
Please, refer to the documentation of {SLES} for more information.
...
{autoyast} only supports limited set of sections compared to {slesa}:
...
In order to invoke it at a later reboot, append
...
More information about Ignition and Combustion, including further examples, can be found in the {opensuse} wiki:
....
